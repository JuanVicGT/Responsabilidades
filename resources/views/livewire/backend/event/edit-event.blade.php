...
<x-mary-card shadow>
    <x-mary-form method="POST" action="{{ route('event.update') }}" x-data="{ submitButtonDisabled: false }"
        ...
        <div class="grid sm:grid-cols-4 gap-4">
            ...
            <div>
                <input type="text" name="id_responsible" x-model="$wire.id_responsible" hidden>
