...
class TodoController extends Controller
{
        ...
        $todos = Todo::select(
            ...
            ->map(function ($todo) {
                ...
                $todo->color = match ($todo->status) {
                    StatusTodoEnum::NotStarted->value => '#C99701',
                    StatusTodoEnum::Started->value => '#00A96E',
                    StatusTodoEnum::Cancelled->value => '#FF5861',
                    StatusTodoEnum::Finished->value => '#0073A0',
                };
    ...
    public function create()
    {
        ...
        $status_options = StatusTodoEnum::array();
